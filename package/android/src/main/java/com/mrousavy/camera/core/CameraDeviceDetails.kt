...
class CameraDeviceDetails(private val cameraInfo: CameraInfo, extensionsManager: ExtensionsManager) {
  ...
  private fun buildFormatMap(photoSize: Size, videoSize: Size, fpsRange: Range<Int>): ReadableMap {
    ...
    map.putDouble("minShutter", exposureDurationRange.lower / 1_000_000_000.0) // Convert nanoseconds to seconds
    map.putDouble("maxShutter", exposureDurationRange.upper / 1_000_000_000.0) // Convert nanoseconds to seconds
